...
class TestPrepareData(unittest.TestCase):
    def test_smoothing_symm(self):
        ...
        ans1 = pandas.DataFrame(list(zip(range(2, 99), numpy.ones(99), 2 * numpy.ones(99))), columns=['x', 'y', 'z'])
        ...
        ans2 = pandas.DataFrame(list(zip(range(2, 100), numpy.ones(100), 2 * numpy.ones(100))), columns=['x', 'y', 'z'])
    ...
    def test_set_smoothing_symm(self):
        ...
        ans1 = pandas.DataFrame(
            list(zip(range(2, 99), numpy.ones(99), 2 * numpy.ones(99), numpy.ones(99), 2 * numpy.ones(98))),
